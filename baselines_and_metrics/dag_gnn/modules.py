...
from utils import my_softmax, get_offdiag_indices, preprocess_adj, preprocess_adj_new, preprocess_adj_new1, my_normalize
...
class MLPEncoder(nn.Module):
    """MLP encoder module."""
    def __init__(self, n_in, n_xdims, n_hid, n_out, adj_A, do_prob=0., factor=True, tol = 0.1):
...
class MLPDEncoder(nn.Module):
    def __init__(self, n_in, n_hid, n_out, adj_A, do_prob=0., factor=True, tol = 0.1):
